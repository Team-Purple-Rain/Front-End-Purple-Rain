...
export default function StartHike({
  ...
  const handleStop = () => {
    ...
    const patchEndLocation = async () => {
      await axios.patch(`https://thatguide.herokuapp.com/map/${ID}/`, {
        end_location: {
          latitude: endHikeLat,
    ...
    const getDistance = async () => {
      await axios.get(`https://thatguide.herokuapp.com/map/${ID}/`, {
      })
        .then((res) => {
          console.log(res);
